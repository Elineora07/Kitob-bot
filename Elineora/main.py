...
async def command_admin(message: types.Message):
    await bot.send_message(message.chat.id, "Assalomu alaykum!\nHurmatli foydalanuvchi botimiz admini: Xudoyqulova Elineora.\nAdmin bilan aloqa:\nTelegram: @Dilnora_Raxmatova\nWeb-site: dilnora007.netlify.app\nBotimizdan foydalanayotganingiz uchun, rahmat.")
...
async def bot_message(message: types.Message):
    ...
    if message.text=="🔙 Back":
    	...
    	await bot.send_message(message.from_user.id, "Bot admini: @Dilnora_Raxmatova")
